...
public class Lista<T> implements List<T>, Iterable<T>
{
    ...
    public Iterator<T> iterator() {
        return new com.company.JavaListT.CustomIterator<>(this);
    }
    ...
    public ListIterator<T> listIterator() {
        return new com.company.JavaListT.CustomListIterator<T>(listIterator());
    }

    @Override
    public ListIterator<T> listIterator(int index) {
        return new com.company.JavaListT.CustomListIterator<T>(this.listIterator(index));
    }

    @Override
    public List<T> subList(int fromIndex, int toIndex) {
        Lista<T> lista = new Lista<T>(Arrays.copyOfRange(array,fromIndex,toIndex + 1));
        return (List<T>)lista;
    }
